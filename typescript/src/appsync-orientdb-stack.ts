...
// import * as orientdb from "kristianmandrup/orientdb-cdk";

export class AppsyncOrientDbStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const vpc = new ec2.Vpc(this, "OrientDBVPC");
    ...
    // const cluster = new orientdb.DatabaseCluster(this, "OrientDbCluster", {
    //   vpc,
    //   instanceType: orientdb.InstanceType.R5_LARGE,
    // });
